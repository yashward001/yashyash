...
def create_anthropic_agent_graph() -> StateGraph:
    llm = ChatAnthropic(temperature=0, model_name="claude-3-5-haiku-20241022")
    # llm = ChatOpenAI(
    #     model="gpt-4o-mini",  # gpt-4o is the correct model name for GPT-4 Omni
    #     temperature=0,
    #     streaming=True  # Optional: Enable streaming if your app supports it
    # )
    # llm = ChatBedrock(
